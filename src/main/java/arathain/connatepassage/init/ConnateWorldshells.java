...
public interface ConnateWorldshells {
	...
	WorldshellSupplier<SplineFollowingAxisLimitedWorldshell> SPLINE = register("spline_following", (map, pos, pivot) -> new SplineFollowingAxisLimitedWorldshell(map, pos, pivot, new Vector3f(0, 0, 1)));
