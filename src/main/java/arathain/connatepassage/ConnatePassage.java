...
public class ConnatePassage implements ModInitializer {
	...
	private static final CatmullRomSplineCurve c = new CatmullRomSplineCurve(8, new Vec3d(-10, -50, -10), new Vec3d(-5, -50, 15), new Vec3d(-10, -50, 30), new Vec3d(10, -50, 20));
		...
		if(QuiltLoader.isDevelopmentEnvironment()) {
			ClientTickEvents.START.register((client -> {
				if(client.world != null) {
					//c.moveLoop(0.1f);
					Vec3d vec = CatmullRomSpline.interpolate((client.world.getTime() % 60) / 60f,  new Vec3d(-20, -50, -10), new Vec3d(-10, -50, 0), new Vec3d(0, -50, -10), new Vec3d(10, -50, 0));
